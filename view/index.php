<?php include "./src/js/web/header.php" ?>
<!-- start container  -->
<div class="container">
...
<script src="../src/js/web/header.js"></script>
<script src="../src/js/web/footer.js"></script>
<script src="../src/js/web/header-rss.js"></script>
</body>
