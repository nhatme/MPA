        ...
        <div class="portfolio_transaction flex f_column" style="margin: 26px 0;">
            <div class="p_16px_0px border-bottom">
                <div style="width: 100%;" class="flex">
                    ...
                    <div style="width: 14.28%" class="second-color-body fs-14px-fw-600">Symbol</div>
            ...
            <div class="p_16px_0px border-bottom pointer">
                <div style="width: 100%;" class="flex align_center">
                    <div style="width: 14.28%" class="fs-12px-fw-600">11-05 12:35:16</div>
                    <div style="width: 14.28%" class="fs-12px-fw-600">BTC</div>
                    <div style="width: 14.28%" class="fs-12px-fw-600">Success</div>
                    <div style="width: 14.28%" class="fs-12px-fw-600">0.6</div>
                    <div style="width: 14.28%" class="fs-12px-fw-600">22,605.54</div>
            ...
            <div class="p_16px_0px border-bottom pointer">
                <div style="width: 100%;" class="flex align_center">
                    <div style="width: 14.28%" class="fs-12px-fw-600">11-05 12:35:16</div>
                    <div style="width: 14.28%" class="fs-12px-fw-600">BTC</div>
                    <div style="width: 14.28%" class="fs-12px-fw-600">Failed</div>
                    <div style="width: 14.28%" class="fs-12px-fw-600">0.6</div>
                    <div style="width: 14.28%" class="fs-12px-fw-600">22,605.54</div>
                    <div style="width: 14.28%" class="fs-12px-fw-600">Sell</div>
                    <div style="width: 14.28%; text-align: center;" class=""><iconify-icon class="fs_24px" icon="material-symbols-light:archive"></iconify-icon></div>
                </div>
            </div>
        </div>
