                ...
                <div class="p_32px">
                    ...
                    <div class="user_main_cuustom flex f_column g_16px">
                        ...
                        <div class="flex f_column">
                            ...
                            <textarea class="fs-14px-fw-500 border_300 p_20px radius-8px outline_none mb_4px resize_none" style="height: 80px;" placeholder="A short introduction about yourself" value="my-username"></textarea>
                        </div>
