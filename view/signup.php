    ...
    <div class="">
        ...
        <div class="">
            ...
            <div class="flex align_top g_8px pt_8px mb_32px">
                <input type="checkbox">
                <p class="fs-15px-fw-500">Please keep me updated by email with the latest crypto news, research findings, reward programs, event updates, coin listings and more information from MarketPlaceAsset.</p>
            </div>
