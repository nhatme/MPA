                ...
                <div class="coin_stats ">
                    ...
                    <div class="coin_stats_header p_24px">
                        <div class="csh__top grid">
                            <img src="https://s2.coinmarketcap.com/static/img/coins/64x64/1.png" width="24px" height="24px" alt="img_coin">
                            <div class="">
                                <span class="m_right_8px fs-18px-fw-700">Bitcoin</span>
                                <span class="fs-12px-fw-500 second-text-color">BTC</span>
                            </div>
                        ...
                        <div class="csh__bottom flex align_center mt_12px g_8px">
                            <span class="fs-40px-fw-700">$37,122.23</span>
                            <div>
                                <div class="fs-16px-fw-600 ">
                                    <iconify-icon class="fs_14px up-price" icon="icon-park-solid:up-one"></iconify-icon>
                                    <span class="up-price">1.07%</span><span class="up-price">(1d)</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="coin_stats_scroll flex f_column g_16px">
                                ...
                                <div>
                                    <div class="flex_sp_bt align_center">
                                        ...
                                        <div class="m_inline_start_8px">
                                            <div class="">
                                                <span class="fs-12px-fw-600">21,000,000 BTC</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
