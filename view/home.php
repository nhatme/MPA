        ...
        <div class="ctn-top">
            <div class="ctn-highlights">
                ...
                <div class="ctn-highlights-switch">
                    ...
                    <img src="./view/src/img/svg/switch-btn.svg" alt="" width="45px">
                </div>
            </div>
        </div>
        <div class="ctn-bottom w_100pc">
            ...
            <div class="ctn-bottom-box">
                ...
                <div class="ctn-bottom-box-detail">
                    <div class="ctn-bottom-box-detail-info">
                        ...
                        <div class="ctn__bbdi__avatar__name">
                            <img class="ctn__bbdi__img" src="./view/src/img/avatar/img2.png" alt="" width="24px" height="24px">
                ...
                <div class="ctn-bottom-box-detail">
                    <div class="ctn-bottom-box-detail-info">
                        ...
                        <div class="ctn__bbdi__avatar__name">
                            <img class="ctn__bbdi__img" src="./view/src/img/avatar/img3.png" alt="" width="24px" height="24px">
                ...
                <div class="ctn-bottom-box-detail">
                    <div class="ctn-bottom-box-detail-info">
                        ...
                        <div class="ctn__bbdi__avatar__name">
                            <img class="ctn__bbdi__img" src="./view/src/img/avatar/img.png" alt="" width="24px" height="24px">
                ...
                <div class="ctn__bb__slider">
                    <img src="./view/src/img/svg/dot-blue.svg" alt="" class="ctn__bb__dot">
                    <img src="./view/src/img/svg/dot-white.svg" alt="" class="ctn__bb__dot">
                </div>
            ...
            <div class="ctn-bottom-box">
                ...
                <div class="ctn__bb__fear__greed">
                    <img class="ctn__bb__fear__greed__svg" src="./view/src/img/svg/fear-greed.svg" alt="">
                </div>
        ...
        <div class="ctn__lists__filter no_wrap scroll_x" draggable="true">
            ...
            <div class="ctn__lf__right">
                ...
                <div class="ctn__showrows">
                    ...
                    <img src="./view/src/img/svg/dropdown-down.svg" alt="">
                </div>

                <div class="ctn__lfrsr__btn">
                    <img src="./view/src/img/svg/filter.svg" alt="">
                    <span class="fs-12px-fw-600">Filters</span>
                </div>

                <div class="ctn__lfrsr__btn">
                    <img src="./view/src/img/svg/customize.svg" alt="">
                    <span class="fs-12px-fw-600">Customize</span>
                </div>

                <div class="ctn__lfr__listorsquare">
                    <img class="ctn__lfrls__selected" src="./view/src/img/svg/three-line.svg" alt="">
                    <img class="ctn__lfrls__square" src="./view/src/img/svg/four-squares.svg" alt="">
                </div>
            </div>
        </div>
...
<div class="bg_color_2 ctn__newsletter">
    <div class="ctn__newsletter__bg">
        ...
        <div class="ctnn_backg">
            <img src="./view/src/img/svg/newsletterbg.svg" alt="" class="ctnn__bg">
        </div>
    </div>
</div>
