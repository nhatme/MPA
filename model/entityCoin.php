...
class CryptoCurrency
{
    ...
    public function __construct($id, $name_product, $symbol, $logo, $cmc_rank, $price, $change_1h, $change_24h, $change_7d, $market_cap, $volume_24h, $circulating_supply, $max_supply, $created_at)
    {
        $this->id = $id;
